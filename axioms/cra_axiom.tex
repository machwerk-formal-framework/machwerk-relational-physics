...
Contextual ambiguity becomes physically inadmissible when the applicable context
cannot be reconstructed. A contradiction arises only when incompatible values
are asserted within one and the same fixed context.
